...
<body>
<!-- DETAILS MODAL -->
    <div class="modal fade" id="fundDetailModalMf">
        <div class="modal-dialog modal-xl">
            ...
            <div class="modal-body">
                <h1><s:property value="fundName"/></h1>
                <div class="row">
                    <div class="col-md-6">
                        <p><b>Fund Type: <s:property value="fundClassification"/></b></p>
                        <p><b>Affiliation: <s:property value="companyName"/></b></p>
                        <p><b>NAVPU/NAVPS (as of MM/DD/YYYY): <s:property value="navps"/></b></p>
                        <hr/>
