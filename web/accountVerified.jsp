...
<body>
    ...
    <div class="h-75 d-flex justify-content-center">
        <div class="card my-auto">
            <div class="account-verified my-auto">
                <div class="card-body">
                    <h4 class="card-title text-uppercase pb-3">Account VERIFIED</h4>
                    <p class="text-center pb-2">
                        You have successfully activated your InvAid account! You can now access the full features of the site which are exclusive to registered users.
                    </p>
                </div>
            </div>
        </div>   
