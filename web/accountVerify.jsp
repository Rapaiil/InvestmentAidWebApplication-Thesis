...
<head>
	...
	<!-- Custom CSS -->
	<link rel="stylesheet" href="css/accountVerify.css" type="text/css" />
...
<body>
    ...
    <div class="h-75 d-flex justify-content-center">
        <div class="card my-auto">
            <div class="account-verification my-auto">
                <div class="card-body">
                    <h4 class="card-title text-uppercase pb-3">Account Verification</h4>
                    <p class="text-center pb-2">
                        We have sent you a verification link to the email you have specified. InvAid accounts require to be activated for the user to be able to utilize them.
                    </p>
                </div>
            </div>
        </div>   
