...
<body>
    ...
    <section class="header">
        ...
        <div class="container header-content text-center mx-auto my-auto">
            <h1>Error 500</h1>
            <h3 class="font-weight-bold">Ooops... Something went wrong.</h3>
            <p>Sorry for the inconvenience, we're working on it.</p>
            <a href="../index.jsp" type="button" class="btn btn-primary button-return-to-home mt-3 text-white">Go Back Home</a>
        </div>
    </section>    
