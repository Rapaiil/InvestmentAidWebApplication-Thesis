...
public class UITFPortfolioAction extends ActionSupport implements SessionAware, DBCommands {
	private List<UserPortfolioFundModel> uitfList = new ArrayList<UserPortfolioFundModel>();
	...
	public List<UserPortfolioFundModel> getUitfList() {
		return uitfList;
	}
